      ...
      <div className="max-w-6xl mx-auto">
        <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
          ...
          <p className="text-gray-600 mb-6">
            Test all features of the Tiptap WYSIWYG editor before integrating
