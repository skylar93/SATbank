    ...
    <div className="p-3 bg-green-50 border border-green-200 rounded">
      ...
      >
        ...
        {uploading ? (
          ...
          <p className="text-center text-sm text-green-800">Drop the image here...</p>
        ) : (
          <div className="text-center">
            <p className="text-sm text-green-700">Drag & drop an image here, or click to select a file.</p>
            <p className="text-xs text-green-600 mt-1">PNG, JPG, GIF up to {maxSize}MB</p>
          </div>
        )}
      </div>
