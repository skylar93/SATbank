...
const supabaseUrl =
  ...
  'https://eoyzqdsxlweygsukjnef.supabase.co'
const supabaseAnonKey =
  process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY ||
  'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImVveXpxZHN4bHdleWdzdWtqbmVmIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTIyODQyODEsImV4cCI6MjA2Nzg2MDI4MX0.1KbMpL3cFkrkWVpHZX-1bXiPEgTo-dZx_j7U3zcHGT4'
...
async function testConnection() {
  ...
  try {
    ...
    console.log(
      'Auth status:',
      authError ? 'Not authenticated' : 'Authenticated'
    )
    ...
    if (errorUnauth) {
      ...
      console.log(
        '✅ Unauthenticated access successful:',
        questionsUnauth?.length || 0,
        'questions found'
      )
    }
    ...
    const { data: questionsService, error: errorService } =
    ...
    if (errorService) {
      ...
      console.log(
        '✅ Service role successful:',
        questionsService?.length || 0,
        'questions found'
      )
