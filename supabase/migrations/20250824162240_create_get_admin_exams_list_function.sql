-- Migration: Create get_admin_exams_list PostgreSQL function
-- Purpose: Optimize admin exam listing by fetching all required data in a single query
-- Solves: N+1 query problem in /admin/exams page
